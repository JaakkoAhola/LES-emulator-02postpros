...
class EmulatorData(PostProcessingMetaData):
    ...
    def __pythonEmulator__leaveOneOutPython(self):
        ...
        print(f"Emulating completed, {self.name}. Time to calculate updrafts {t2-t1:.1f}, avg. {timepercase}, maxiter: {self.optimization['maxiter']}, n_restarts_optimizer: {self.optimization['n_restarts_optimizer']}, boundOrdo: {self.boundOrdo}")
